...
//!
//! Lives in the foundation layer so every crate that has to pass
//! arbitrary text through `CCu base64:<payload>` (the r2 adapter's live
//! annotation path and the report crate's r2-script renderer alike) can
//! share one encoder without adding a third-party base64 crate to the
