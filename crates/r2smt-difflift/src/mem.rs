...
//!
//! ```text
//! mv_j = ite(k_j == k_0, mv_0, ite(k_j == k_1, mv_1, … mb_j))
//! ```
//!
//! Earliest match wins, which makes the relation a total function on the
//! key set: equal addresses are *forced* to equal bytes, transitively.
//! That is precisely the property whose absence fabricates.
//!
